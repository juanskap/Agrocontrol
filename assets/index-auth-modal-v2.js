(() => {
  ...
  const copy = {
    es: {
      auth: {
        promoLabel: "Empieza a comprar hoy 🛒",
        slogan: "Compra facil, rapida y sin vueltas.",
        promoText: "Crea tu cuenta y ten tus datos listos para seguir comprando cuando quieras.",
    ...
    en: {
      auth: {
        promoLabel: "Start shopping today 🛒",
        slogan: "Easy, fast shopping with no friction.",
        promoText: "Create your account and keep your details ready to continue shopping anytime.",
        formLabel: "Log in 🔐",
  ...
  function showMessage(target, message, type = "error") {
    ...
    target.classList.remove("border-rose-200", "bg-rose-50", "text-rose-700", "border-emerald-200", "bg-emerald-50", "text-emerald-700", "border-rose-500/30", "bg-rose-500/10", "text-rose-100");
    if (type === "success") {
      target.classList.add("border-emerald-200", "bg-emerald-50", "text-emerald-700");
    } else {
      target.classList.add("border-rose-500/30", "bg-rose-500/10", "text-rose-100");
    }
